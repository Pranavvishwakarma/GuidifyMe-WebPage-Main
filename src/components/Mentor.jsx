...
const data = [
...

  {
    ...
    line: "As a GuidifyMe mentor, you're free to teach in your own style and customize your approach based on your mentees ' goals.",
  },
  {
    image: pro5,
        ...
        <div className="md:max-w-lg">
          <div className="space-y-4">
            ...
            <p className="text-[#8ca1b3]">
              As a GuidifyMe mentor, you'll get to provide mentorship to
